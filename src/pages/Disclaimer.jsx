  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <h1 className="text-center display-4 font-weight-bold mb-4">Disclaimer</h1>
        ...
        <section className="my-4">
          <h2 className="font-weight-bold">1. Professional Disclaimer</h2>
          <p>
        ...
        <section className="my-4">
          <h2 className="font-weight-bold">2. External Links Disclaimer</h2>
          <p>
        ...
        <section className="my-4">
          <h2 className="font-weight-bold">3. Limitation of Liability</h2>
          <p>
        ...
        <section className="my-4">
          <h2 className="font-weight-bold">4. Contact Us</h2>
          <p>
            If you have any questions about this disclaimer, you can contact us at <a href="/contactus" className="text-success">Contact Us</a>.
          </p>
        </section>
      </div>
    </>
