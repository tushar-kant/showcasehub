                ...
                <div className="row align-items-center vh-90">
                    <div className="col-md-7 text-center text-md-left">
                        <h1 className="display-3 font-weight-bold mb-4">
                            Welcome to <span className='text-success'>ShowcaseHub</span>
                        </h1>
                        ...
                        <div className="container">
                            <Link className="btn btn-primary btn-lg m-2" to="/projecttype" role="button">Explore Projects</Link>
                            <Link className="btn btn-primary btn-lg m-2" to="/ebook" role="button">Explore Ebooks</Link>
                ...
                <div className="row text-center mt-5">
                    <div className="col-md-4 mb-4">
                        <div className="icon-box">
                            ...
                            <p>Discover trending projects and ebooks in various technology stacks and categories.</p>
                        </div>
                    </div>
                    <div className="col-md-4 mb-4">
                        <div className="icon-box">
                            <h2 className="font-weight-bold">Community</h2>
                            <p>Join a vibrant community of developers, authors, mentors, and enthusiasts.</p>
                        </div>
                    </div>
                    <div className="col-md-4 mb-4">
                        <div className="icon-box">
                            <h2 className="font-weight-bold">Customization</h2>
                            <p>Customize your profile and preferences to tailor your browsing experience.</p>
                        </div>
                    </div>
                </div>
            </div>
